...
public interface BondCalculator {
	public double yield_to_maturity(Util.Bond_frequency_type frequency_type, Util.Interest_basis interest_basis, double actual_price, double coupon_rate, int par, Date settlement, Date maturity);
